  ...
  var questions = [
  new Question('신체 접촉이 없을 경우 해당 행동은 성희롱이 되지 않는다.', ['a. 그렇다', 'b. 그렇지 않다',], 'b. 그렇지 않다'),

  new Question('성적인 농담에 모두가 웃는다면 이는 성희롱으로 간주될 수 없다.', ['a. 그렇다', 'b. 그렇지 않다'], 'b. 그렇지 않다'),
  ...
  new Question('동료가 성희롱을 당했다고 말하면 다음과 같이 행동하는 것이 최선이다.', ['a. 사건을 웃어 넘기며 가해자로 지목된 사람을 옹호한다.', 'b. 회사 정책을 이야기하고, 인사 담당자에게 보고해야 한다고 말한다.', 'c.즉시 인사과에 연락해 가해자의 해고를 요청한다.', 'd. 동료의 행동을 과민반응이라고 말한 뒤 지목된 가해자에게 가서 동료가 그를 비난한다고 전한다. ' ], 'b. 회사 정책을 이야기하고, 인사 담당자에게 보고해야 한다고 말한다.'),

  new Question('괴롭힘이 불법적이려면.....', ['a. 달갑지 않은 것이어야 한다', 'b. 원치 않은 것이어야 한다', 'c. A와 B 모두 해당', 'd.	남녀 사이의 일이어야만 한다'], 'c. A와 B 모두 해당'),

  new Question('성적인 발언을 하는 것, 사내 성적 농담을 허용하는 것을 일컫는 말은..... ', ['a. 대가성(Quid Pro Quo) 성희롱', 'b. 적대적 환경 성희롱', 'c.	일반적인 사무 환경', 'd. A와 B 모두 해당'], 'b. 적대적 환경 성희롱'),

  new Question('당신은 맨디가 마크에게 성적인 발언을 하는 것을 목격한다. 마크가 해당 발언을 불편해 하는 것 같다고 여긴 당신은 마크에게 다가가 묻는다. 마크는 맨디가 고위급 직원이며 모두가 그녀를 좋아하기 때문에 경영진에게 이야기를 꺼내기가 두렵다고 한다. 이때 당신은... ', ['a. 아무 것도 하지 않고 문제가 해결되기를 바라야 한다.', 'b.	재발을 대비해 적어 두어야 한다.', 'c.	직접 맨디에게 가서 마크에 대한 해당 발언을 중지하라고 말해야 한다.', 'd. 목격한 것을 상사 또는 인사 관리자에게 보고해야 한다.'], 'd. 목격한 것을 상사 또는 인사 관리자에게 보고해야 한다.'),

  new Question('EZ Computers의 부서장인 로베르타는 알렉스를 보조원으로 고용한다. 알렉스가 회사에서 업무를 시작하고 얼마 지나지 않아, 로베르타는 알렉스에게 EZ Computers에서 계속 일하려면 자신과 섹스를 해야만 한다고 말한다. 알렉스는 그 요구가 매우 불쾌했으나 직장을 잃고 싶지 않기 때문에 수락한다. 알렉스가 로베르타의 요구에 따랐으므로 이 상황은 성희롱이 아니라 법적 성인이 성관계에 동의한 것이다.', ['a. 그렇다', 'b. 그렇지 않다'], 'b. 그렇지 않다'),
  ...
  new Question('이성 동료의 외모를 칭찬하는 것은 성희롱이다.', ['a. 그렇다', 'b. 그렇지 않다'], 'b. 그렇지 않다'),
