...
class Register
{
  ...
  public function registerUser() {
    ...
    if(empty($author['ethnicity'])) {
      $valid = false;
      $errors[] = 'ethnicity을 입력해야 합니다.';
    }
    if(empty($author['address'])) {
      $valid = false;
      $errors[] = 'address을 입력해야 합니다.';
    }
    if(empty($author['jobStatus'])) {
      $valid = false;
      $errors[] = 'jobStatus을 입력해야 합니다.';
    }
    ...
    if(empty($author['dateOfHired'])) {
      $valid = false;
      $errors[] = 'dateOfHired을 입력해야 합니다.';
    }
