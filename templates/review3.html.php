...
<?php if(strpos($_SERVER['REQUEST_URI'], "eng")): ?>
  <div class="title lastcheck" onclick="location.href='lastcheck3_eng'">
    <button class="custom-btn btn-4">Go back to the last page</button>
  </div>
  <?php endif;?>
  <?php if(strpos($_SERVER['REQUEST_URI'], "spn")): ?>
  <div class="title lastcheck" onclick="location.href='lastcheck3_spn'">
    <button class="custom-btn btn-4">Go back to the last page</button>
  </div>
  <?php endif;?>
  <?php if(strpos($_SERVER['REQUEST_URI'], "kor")): ?>
  <div class="title lastcheck" onclick="location.href='lastcheck3_kor'">
    <button class="custom-btn btn-4">Go back to the last page</button>
  </div>
  <?php endif;?>
  <div class="slider">
