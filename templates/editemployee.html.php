...
<form action="" method="post" id="edit_form">
  ...
  <!-- <div id="input_text">
  <label for="joketext"> Write your text: </label>
  <textarea id="joketext" name="joke[joketext]" rows="10" cols="150"><?=$joke->joketext ?? ''?></textarea>
  </div>

  <div id="input_category">
    <p>Select categories of your article(more than 1 option): </p>
