...
<html lang="en" dir="ltr">
  ...
  <?php if(strpos($_SERVER['REQUEST_URI'], "eng")): ?>
  <div class="title" onclick="location.href='lastcheck2_eng'">
    <button class="custom-btn btn-4">Go back to the last page</button>
  </div>
  <?php endif;?>
  <?php if(strpos($_SERVER['REQUEST_URI'], "spn")): ?>
  <div class="title" onclick="location.href='lastcheck2_spn'">
    <button class="custom-btn btn-4">Go back to the last page</button>
  </div>
  <?php endif;?>
  <?php if(strpos($_SERVER['REQUEST_URI'], "kor")): ?>
  <div class="title" onclick="location.href='lastcheck2_kor'">
    <button class="custom-btn btn-4">Go back to the last page</button>
  </div>
  <?php endif;?>
  </body>
